...
public class SocketInputStream extends InputStream {
  ...
  /**
   * Read the request line, and copies it to the given buffer. This function is meant to be used
   * during the HTTP request header parsing. Do NOT attempt to read the request body using it.
   *
   * @param requestLine Request line object
   * @throws IOException If an exception occurs during the underlying socket read operations, or if
   *     the given buffer is not big enough to accomodate the whole line.
   */
  ...
  /**
   * Read a header, and copies it to the given buffer. This function is meant to be used during the
   * HTTP request header parsing. Do NOT attempt to read the request body using it.
   *
   * @param requestLine Request line object
   * @throws IOException If an exception occurs during the underlying socket read operations, or if
   *     the given buffer is not big enough to accomodate the whole line.
